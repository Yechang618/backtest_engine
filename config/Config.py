...
class Config:
    ...
    # Exclude BJ
    FEATURE_SELECTED_LGBM =  ['DAYS_SINCE_UPDATE_CF_MKT_Z', 'CR_MA_5_MKT_Z', 'PV_LIMIT_RET_FROM_PRECLOSE_MKT_Z', 'Breadth_industry', 'DAYS_SINCE_UPDATE_IC_MKT_Z', 'DAYS_SINCE_UPDATE_BS_MKT_Z', 'KAMA_SLOPE_MKT_Z', 'TURNOVER_SHARE_OF_MARKET_MKT_Z', 'FIX_ASSETS_DISP_BS_IND_Z', 'PRODUCTIVE_BIO_ASSETS_BS_IND_Z', 'CR_MA_10_MKT_Z', 'BOTTOM_BUILD_B_5_MKT_Z', 'SHARPE_10D_MKT_Z', 'SMR_12_MKT_Z', 'PSY_12_MKT_Z', 'IFT_RSI_14_MKT_Z', 'AROON_DOWN_25_MKT_Z', 'CRSI_STREAK_RSI2_MKT_Z', 'DAYS_SINCE_LAST_UP_FRACTAL_MKT_Z', 'BOTTOM_BUILD_D_10_MKT_Z', 'LESS_BEG_BAL_CASH_EQU_CF_IND_Z', 'FORCE_LOG_TANH_MKT_Z', 'BORROW_CENTRAL_BANK_BS_IND_Z', 'STC_10_23_50_MKT_Z', 'DAYS_SINCE_LAST_DOWN_FRACTAL_MKT_Z', 'LOANS_OTH_BANKS_BS_IND_Z', 'Breadth_global']
    FEATURE_SELECTED_XGB =   ['FORCE_EMA_2_MKT_Z', 'PVT_REL_20_MKT_Z', 'PV_CAPITAL_LOG_MKT_Z', 'DAYS_SINCE_UPDATE_IC_MKT_Z', 'Breadth_industry', 'FIX_ASSETS_DISP_BS_IND_Z', 'PSY_12_MKT_Z', 'CR_MA_10_MKT_Z', 'PRODUCTIVE_BIO_ASSETS_BS_IND_Z', 'TURNOVER_SHARE_OF_MARKET_MKT_Z', 'PV_LIMIT_RET_FROM_PRECLOSE_MKT_Z', 'DAYS_SINCE_UPDATE_BS_MKT_Z', 'SHARPE_10D_MKT_Z', 'BOTTOM_BUILD_B_5_MKT_Z', 'IFT_RSI_14_MKT_Z', 'AROON_DOWN_25_MKT_Z', 'CRSI_STREAK_RSI2_MKT_Z', 'DAYS_SINCE_LAST_UP_FRACTAL_MKT_Z', 'BOTTOM_BUILD_D_10_MKT_Z', 'LESS_BEG_BAL_CASH_EQU_CF_IND_Z', 'FORCE_LOG_TANH_MKT_Z', 'BORROW_CENTRAL_BANK_BS_IND_Z', 'STC_10_23_50_MKT_Z', 'DAYS_SINCE_LAST_DOWN_FRACTAL_MKT_Z', 'LOANS_OTH_BANKS_BS_IND_Z', 'Breadth_global']
